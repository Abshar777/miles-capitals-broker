...
const Mt5ToMt5ransferList = (props: Props) => {
  // Showcasing the use of search params cache in nested RSCs
  const router = useRouter();
  const { data, isLoading, total, params, updateParams } = useMTransferHistory();
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:flex items-center gap-2">
        ...
        <div className="relative col-span-2   text-sm">
          ...
          <Input
            ...
            value={params.login}
            onChange={(e) => updateParams("login", e.target.value)}
...
export default Mt5ToMt5ransferList;
