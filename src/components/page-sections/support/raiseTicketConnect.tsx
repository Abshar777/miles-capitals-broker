...
/** Reference empty state for the helpdesk. */
const RaiseTicketConnect = () => {
  ...
  return (
    <div className="flex h-full min-h-[360px] w-full flex-col text-center items-center justify-center gap-3 rounded-[4px] border border-border">
      ...
      <h1 className="text-[24px] leading-8 font-medium text-foreground">No tickets yet</h1>
      <p className="text-[15px] leading-6 text-muted-foreground max-w-[360px]">
        Raise your first ticket and our support team will get back to you
      </p>
      <button
        type="button"
...
export default RaiseTicketConnect;
