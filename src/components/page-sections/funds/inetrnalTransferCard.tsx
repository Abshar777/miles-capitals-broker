  ...
  return (
    <motion.div className="md:col-span-2 md:pr-6" variants={item_variants}>
      <Card className="bg-transparent py-0 gap-4">
        <CardHeader className="px-0"><CardTitle>Internal Transfer</CardTitle></CardHeader>
        <CardContent className="relative px-0 pb-10">
          <p className="mb-4 text-[15px] leading-6 text-muted-foreground">Note! Transfer funds between wallets internally</p>
