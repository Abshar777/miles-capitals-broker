...
import InternalTransferList from "@/components/table/inetrnalTransfer/internalTransferList";

const InternalTransactionsCard = () => {
...
export default InternalTransactionsCard;
