...
import AllTransferList from "@/components/table/allTransfers/allTransferList";

const AllTransactionsCard = () => {
    const { form, onFormSubmit, errors } = useZodForm(depositeSchema, () => { });
    return (
        <motion.div initial="hidden" className="w-full  h-full" animate="visible" variants={container_variants}>
            <Form {...form}>
